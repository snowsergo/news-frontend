export default class NewsApi {
  ...
  getNews(keyword, weekago, today) {
    ...
    return fetch(`http://cors-anywhere.herokuapp.com/http://newsapi.org/v2/everything?q=${keyword}&from=${weekago}&to=${today}&language=ru&sortBy=popularity&pageSize=10&apiKey=fa485188ab5044baaf48fed1bd8263b1`,{
   //   mode: 'no-cors',
    })
    .then(res => res.json())
